...
-- SELECT DISTINCT country, COUNT(company_name) AS count_c FROM suppliers GROUP BY country ORDER BY count_c
...
-- SELECT SUM(freight) AS total_fr, ship_country
-- FROM orders
...
-- SELECT country FROM customers WHERE company_name IS NOT NULL
-- UNION
-- SELECT country FROM suppliers WHERE company_name IS NOT NULL
-- UNION
